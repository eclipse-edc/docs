...
- Familiarize yourself with [coding style](../developer/contributing/styleguide.md), [architectural patterns](../developer/contributing/coding-principles.md), 
...
- If you introduce new 3rd party dependencies, be sure to note them in the PR description and explain why they are
  necessary.
- Stick to the established code style, please refer to the [styleguide document](../developer/contributing/styleguide.md).
