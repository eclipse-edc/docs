...
our [GitHub Actions pipeline](../../docs/submodule/GitHub/.github/workflows/verify.yaml). At this time, Checkstyle will only spew out warnings, but
...
![](IdeaProjects/edc/docs/resources/save_actions_screenshot.png)
